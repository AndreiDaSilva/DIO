        ...
        >
            ...
            >
                <Box display='flex' flexDirection='column' alignItems='center' color='#fff'>
                    ...
                    <Text fontSize='1xl' maxW='60%' textAlign='center' fontWeight='100' p='2rem'>Ainda não tem cadastro? Crie um é rápido e fácil! Click no botão a baixo e faça agora memso.</Text>
                    <CButton
                        title='CADASTRAR'
                        variant='outline'
                        colorScheme='gray'
